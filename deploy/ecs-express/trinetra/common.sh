#!/usr/bin/env bash
# Shared helpers for deploy/ecs-express/trinetra/*.sh. Not meant to be run
...
# path is Trinetra-specific.

MANIFEST_PATH_DEFAULT="$HOME/.trinetra-ecs-express-deployment.json"
MANIFEST_PATH="${TRINETRA_ECS_MANIFEST:-$MANIFEST_PATH_DEFAULT}"
